...
export const metadata: Metadata = {
  title: "Méthodologie — Comment on compare les prix | EuroPrix",
  description: "Découvrez comment EuroPrix collecte, calcule et présente les prix Amazon entre la France, l'Allemagne et l'Espagne.",
}
      ...
      sections={[
        {
          ...
          content: (
            <>
              <p>EuroPrix collecte les prix directement sur les pages produits des boutiques Amazon officielles de chaque pays : Amazon.fr (France), Amazon.de (Allemagne) et Amazon.es (Espagne).</p>
        ...
        },
        {
          ...
          content: (
            <>
              <p>Le prix affiché sur EuroPrix est toujours le <strong>prix total livré en France</strong>, c'est-à-dire :</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><strong>Important :</strong> Vérifiez toujours le prix affiché sur le site Amazon au moment de votre achat. EuroPrix ne peut garantir que le prix affiché sur notre site correspond exactement au prix réel au moment de votre commande.</p>
            </>
          ),
        },
        {
          ...
          content: (
            <p>Les produits présentés sur EuroPrix sont sélectionnés manuellement sur la base de leur popularité, des économies potentielles identifiées et de leur disponibilité dans les trois pays couverts. Nous privilégions les produits pour lesquels l'écart de prix entre pays est significatif et vérifiable.</p>
          ),
        },
        {
          title: "Liens affiliés",
          content: (
            <p>EuroPrix participe au programme Partenaires d'Amazon EU. Les liens vers Amazon présents sur ce site sont des liens affiliés : si vous achetez un produit via l'un de ces liens, EuroPrix perçoit une commission sur la vente, sans coût supplémentaire pour vous. Cette commission nous permet de financer le développement et la maintenance du site.</p>
          ),
        },
      ]}
    />
